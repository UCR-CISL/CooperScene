...
from opencood.utils.transformation_utils import x1_to_x2, get_world_T_from_euler_degrees
...
class EarlyFusionVisDataset(basedataset.BaseDataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.params['filter_lidar_points']:
    ...
    def get_item_single_car(self, selected_cav_base, ego_pose):
        ...
        if self.useENU:
            transformation_matrix = get_world_T_from_euler_degrees(selected_cav_base['params']['lidar_pose'])
        else:
