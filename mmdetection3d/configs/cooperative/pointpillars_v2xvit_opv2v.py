...
custom_imports = dict(
    imports=[
        'mmdet3d.models.cooperative_modules',
        'mmdet3d.models.detectors.cooperative_detector',
        'mmdet3d.datasets.transforms.cooperative_loading',
    ],
...
model = dict(
    ...
    fusion_module=dict(
        ...
        encoder=dict(
            ...
            feed_forward=dict(mlp_dim=256, dropout=0.3),
            sttf=dict(voxel_size=voxel_size, downsample_rate=4))),
