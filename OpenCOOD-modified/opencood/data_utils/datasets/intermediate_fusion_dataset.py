...
class IntermediateFusionDataset(basedataset.BaseDataset):
    ...
    """
    def __init__(self, params, visualize, train=True, dataset_type='opv2v'):
        ...
        self.post_processor = post_processor.build_postprocessor(
            params['postprocess'],
            train)
        self.dataset_type = dataset_type  # keep the dataset type
        ...
        print(f"Project first setting: {self.proj_first}")
    ...
    def get_item_single_car(self, selected_cav_base, ego_pose):
        ...
        # choose the reference parameter based on the dataset type
        reference_param = transformation_matrix if self.dataset_type == 'v2v4real' else ego_pose
