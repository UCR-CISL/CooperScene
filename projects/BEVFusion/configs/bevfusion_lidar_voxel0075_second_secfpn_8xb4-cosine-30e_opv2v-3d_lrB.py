...
# ===================== Model Settings =====================
# LR Strategy B: Simple monotonic cosine decay, no warmup
# Changes from original:
#   - No cyclic warmup, just simple cosine decay
#   - Peak lr: 0.0002 (start high, decay to near zero)
#   - Training epochs: 30
...
# ===================== Training Settings =====================
# Strategy B: Simple monotonic cosine decay (no warmup cycle)
# - Start lr: 0.0002 (peak)
# - End lr: 1e-6
# - Total epochs: 30
# - No warmup phase, just smooth decay from start
lr = 0.0002
param_scheduler = [
    dict(
