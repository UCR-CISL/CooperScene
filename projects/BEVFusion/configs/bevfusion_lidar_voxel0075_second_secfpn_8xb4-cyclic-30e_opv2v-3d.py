...
#   - Warmup peak lr: 0.001 -> 0.0002 (5x lower)
...
# ===================== Training Settings =====================
# Strategy A: Lower warmup peak lr, longer training
# - lr = 0.0001 (unchanged)
# - warmup peak: lr * 2 = 0.0002 (was lr * 10 = 0.001)
# - warmup epochs: 10 (was 8)
# - total epochs: 30 (was 20)
lr = 0.0001
param_scheduler = [
    # Warmup phase: lr rises from 0.0001 to 0.0002 over 10 epochs
    dict(
        type='CosineAnnealingLR',
        T_max=10,
        eta_min=lr * 2,  # Peak lr = 0.0002 (was lr * 10 = 0.001)
        begin=0,
        end=10,
        by_epoch=True,
        convert_to_iter_based=True),
    # Decay phase: lr drops from 0.0002 to 1e-8 over 20 epochs
    dict(
        type='CosineAnnealingLR',
        T_max=20,
        eta_min=lr * 1e-4,
