"""Shared transformer blocks: PreNorm, FeedForward, CavAttention.
"""
import torch
...
class CavAttention(nn.Module):
    ...
    def forward(self, x, mask, prior_encoding):
        ...
        out = torch.einsum('b m h w i j, b m h w j c -> b m h w i c',
                           att_map, v)
    ...
    def __init__(self, dim, depth, heads, dim_head, mlp_dim, dropout=0.):
        ...
        for _ in range(depth):
            self.layers.append(nn.ModuleList([
                PreNorm(dim, CavAttention(dim, heads=heads, dim_head=dim_head,
                                          dropout=dropout)),
